...
plot "<paste ../dados/Ux/LA_x_0.0019m.dat ../caso/postProcessing/sampleUx/188/LA.xy"  using (abs($1)-abs($4)):($3) title "{num}" with lines lt 2 lw 2.5
